...
class GeminiTasteProfileAdapter(HttpClientMixin, TasteProfilerPort):
    ...
    async def merge_profiles(self, foundation: TasteProfileData, new_segment: TasteProfileData) -> TasteProfileData:
        ...
        prompt = (
            ...
            "   - Calculate a weighted average: (Foundation * 0.7) + (Segment * 0.3).\n"
            "   - For existing keys, update the weight. For new keys with segment weight > 0.3, add them.\n"
            "   - Example: Foundation 'Jazz': 0.8 + Segment 'Jazz': 0.2 = New weight 0.62.\n\n"
            "3. current_vibe:\n"
