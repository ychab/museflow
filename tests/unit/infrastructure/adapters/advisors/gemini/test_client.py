...
class TestParseRetryDelay:
    def test__valid(self) -> None:
        ...
        assert GeminiClientAdapter._parse_retry_delay(body) == 38
    ...
    def test__no_detail(self) -> None:
        ...
        assert GeminiClientAdapter._parse_retry_delay(body) is None

    def test__malformed_body(self) -> None:
        assert GeminiClientAdapter._parse_retry_delay(b"not-json") is None
