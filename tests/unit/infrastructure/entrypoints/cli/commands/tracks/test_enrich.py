...
from museflow.infrastructure.entrypoints.cli.commands.tracks.enrich import EnrichTracksReport
from museflow.infrastructure.entrypoints.cli.commands.tracks.enrich import enrich_logic
from museflow.infrastructure.entrypoints.cli.main import app

from tests.unit.infrastructure.entrypoints.cli.conftest import TextCleaner

TARGET_PATH: Final[str] = "museflow.infrastructure.entrypoints.cli.commands.tracks.enrich"


class TestEnrichParserCommand:
    ...
    def test__email__invalid(self, runner: CliRunner, clean_typer_text: TextCleaner) -> None:
        result = runner.invoke(app, ["tracks", "enrich", "--email", "notanemail"])
    ...
    def test__batch_size__defaults_to_200(self, runner: CliRunner, mock_enrich_logic: mock.AsyncMock) -> None:
        runner.invoke(app, ["tracks", "enrich", "--email", "test@example.com"])
...
class TestEnrichCommand:
    ...
    def test__nominal(self, runner: CliRunner) -> None:
        result = runner.invoke(app, ["tracks", "enrich", "--email", "test@example.com"])
        assert result.exit_code == 0
